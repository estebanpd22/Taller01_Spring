...
public class SeatInventoryControllerTest {
    ...
    void create_shouldReturn201() throws Exception {
        var request = new SeatInventoryCreateRequest(Cabin.ECONOMY, 150, 150, 1L);
        var flightResponse = new FlightResponse(1L, "AV123", null, null, null, null, null, null);
        var response = new SeatInventoryResponse(1L, Cabin.ECONOMY, 150, 150, flightResponse);

        when(seatInventoryService.create(any(SeatInventoryCreateRequest.class))).thenReturn(response);
        ...
        verify(seatInventoryService).create(any(SeatInventoryCreateRequest.class));
    }
    ...
    void getAll_shouldReturn200() throws Exception {
        var flightResponse = new FlightResponse(1L, "AV123", null, null, null, null, null, null);
        var inventory1 = new SeatInventoryResponse(1L, Cabin.ECONOMY, 150, 150, flightResponse);
        var inventory2 = new SeatInventoryResponse(2L, Cabin.BUSINESS, 30, 30, flightResponse);
    ...
    void findByFlightAndCabin_shouldReturn200() throws Exception {
        ...
        mockMvc.perform(get("/api/seat-inventories/flight/1/cabin/ECONOMY"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1))
                .andExpect(jsonPath("$.cabin").value("ECONOMY"))
                .andExpect(jsonPath("$.totalSeats").value(150))
    ...
    void update_shouldReturn200() throws Exception {
        var request = new SeatInventoryUpdateRequest(Cabin.ECONOMY, 150, 140, 1L);
        var flightResponse = new FlightResponse(1L, "AV123", null, null, null, null, null, null);
        var response = new SeatInventoryResponse(1L, Cabin.ECONOMY, 150, 140, flightResponse);

        when(seatInventoryService.update(eq(1L), any(SeatInventoryUpdateRequest.class))).thenReturn(response);
        ...
        verify(seatInventoryService).update(eq(1L), any(SeatInventoryUpdateRequest.class));
    }

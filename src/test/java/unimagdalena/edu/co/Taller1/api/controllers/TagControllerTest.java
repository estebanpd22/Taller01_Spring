...
public class TagControllerTest {
    ...
    void create_shouldReturn201() throws Exception {
        var request = new TagCreateRequest("Direct Flight");
        var response = new TagResponse(1L, "Direct Flight", List.of());
    ...
    void listAll_shouldReturn200() throws Exception {
        var tag1 = new TagResponse(1L, "Direct Flight", List.of());
        var tag2 = new TagResponse(2L, "Economy", List.of());
    ...
    @Test
    void listByNameIn_shouldReturn200() throws Exception {
        var tag1 = new TagResponse(1L, "Direct Flight", List.of());
        var tag2 = new TagResponse(2L, "Economy", List.of());
        var tags = List.of(tag1, tag2);

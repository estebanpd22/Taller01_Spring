...
public class BookingItemServiceImplTest {
    ...
    void shouldCreateBookingItem() {
        ...
        var dto = new BookingItemCreateRequest(new BigDecimal(344), 2, Cabin.BUSINESS, 34L);
    ...
    void shouldUpdateBookingItem() {
        ...
        var updateRequest = new BookingItemUpdateRequest(
    ...
    void shouldReturnItemsOrderedBySegment() {
        ...
        when(itemRepository.findByBooking_IdOrderBySegmentOrder(bookingId))
